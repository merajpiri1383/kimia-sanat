    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked', models.ManyToManyField(blank=True, related_name='products_liked', to=settings.AUTH_USER_MODEL)),
                ('views', models.ManyToManyField(to='user.ip')),
                ('standard', models.ManyToManyField(blank=True, to='product.standard', verbose_name='استاندارد ها')),
            ],
            options={
                'verbose_name': 'محصول',
