    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.SlugField(blank=True, null=True, verbose_name='کد پروژه')),
                ('video', models.FileField(blank=True, null=True, upload_to='project/video/', verbose_name='ویدیو پروژه')),
                ('main_image', models.ImageField(blank=True, null=True, upload_to='project/images/', verbose_name='تصویر شاخص پروژه')),
